...
import ru.ifmo.weatherproject.provider.WeatherContract;


public class WeatherLoaderService extends IntentService {
    public static final String ACTION_ADD_CITY_BY_NAME = "ru.ifmo.weatherproject.action.ADD_CITY_BY_NAME";
    public static final String ACTION_ADD_CITY_BY_COORD = "ru.ifmo.weatherproject.action.ADD_CITY_BY_COORD";
    public static final String ACTION_UPDATE_CITY = "ru.ifmo.weatherproject.action.UPDATE_CITY";
    public static final String ACTION_UPDATE_ALL = "ru.ifmo.weatherproject.action.UPDATE_ALL";

    public static final String EXTRA_CITY_NAME = "ru.ifmo.weatherproject.extra.CITY_NAME";
    public static final String EXTRA_CITY_ID = "ru.ifmo.weatherproject.extra.CITY_ID";
    public static final String EXTRA_CITY_LATITUDE = "ru.ifmo.weatherproject.extra.CITY_LATITUDE";
    public static final String EXTRA_CITY_LONGITUDE = "ru.ifmo.weatherproject.extra.CITY_LONGITUDE";
    public static final String EXTRA_CITY_WEATHER_ID = "ru.ifmo.weatherproject.extra.CITY_WEATHER_ID";
    ...
    private static final String SEARCH_FORMAT = "http://api.openweathermap.org/data/2.5/weather?q=%s&mode=xml&units=metric&appid=c26bd56553cbf46d4f8eb3f286552f39";
    private static final String FORECAST_FORMAT = "http://api.openweathermap.org/data/2.5/forecast/daily?id=%s&mode=xml&units=metric&cnt=5&appid=c26bd56553cbf46d4f8eb3f286552f39";
    private static final String CURRENT_FORMAT = "http://api.openweathermap.org/data/2.5/weather?id=%s&mode=xml&units=metric&appid=c26bd56553cbf46d4f8eb3f286552f39";
    private static final String LOCATION_FORMAT = "http://api.openweathermap.org/data/2.5/weather?lat=%f&lon=%f&mode=xml&units=metric&appid=c26bd56553cbf46d4f8eb3f286552f39";
